 ...
 */
class CRM_GenerateQRLetters_Upgrader_Base {

  /**
   * @var CRM_GenerateQRLetters_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_GenerateQRLetters_Upgrader(
        'generateqrletters',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_GenerateQRLetters_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_GenerateQRLetters_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
